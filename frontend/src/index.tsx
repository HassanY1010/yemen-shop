...
// Admin API routes are handled directly by adminRoutes mounted at /api/admin above
...
app.get('/api/init-db', async (c) => {
  try {
    const tables = [
      ...
      `CREATE TABLE IF NOT EXISTS products (id INTEGER PRIMARY KEY AUTOINCREMENT, store_id INTEGER NOT NULL, category_id INTEGER, name TEXT NOT NULL, slug TEXT NOT NULL, description TEXT, short_description TEXT, sku TEXT, price REAL DEFAULT 0, sale_price REAL, currency TEXT DEFAULT 'YER', stock INTEGER DEFAULT 0, manage_stock INTEGER DEFAULT 1, status TEXT DEFAULT 'active', featured INTEGER DEFAULT 0, is_featured INTEGER DEFAULT 0, sort_order INTEGER DEFAULT 0, views INTEGER DEFAULT 0, total_sold INTEGER DEFAULT 0, tags TEXT DEFAULT '[]', created_at DATETIME DEFAULT CURRENT_TIMESTAMP, updated_at DATETIME DEFAULT CURRENT_TIMESTAMP)`,
    ...
    const alters = [
      ...
      "ALTER TABLE products ADD COLUMN currency TEXT DEFAULT 'YER'"
    ]
